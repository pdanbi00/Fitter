...
public class RankController {
	...
	public ResponseEntity<WodRankDto> getMyRank(@PathVariable(name = "wodName") String wodName, @RequestHeader(name = "Authorization") String accessToken) {
		try {
